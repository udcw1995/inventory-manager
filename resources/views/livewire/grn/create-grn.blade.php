<div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
    ...
    @if (session()->has('message'))
        <div class="mb-6 bg-green-100 dark:bg-green-900/20 border border-green-400 dark:border-green-500 text-green-700 dark:text-green-300 px-4 py-3 rounded relative" role="alert">
    ...
    @if (session()->has('error'))
        <div class="mb-6 bg-red-100 dark:bg-red-900/20 border border-red-400 dark:border-red-500 text-red-700 dark:text-red-300 px-4 py-3 rounded relative" role="alert">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Create New GRN</h2>
        </div>
        ...
        <form wire:submit="save" class="p-6 space-y-6">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" 
                    ...
                    <span wire:loading.remove wire:target="save">Save GRN</span>
